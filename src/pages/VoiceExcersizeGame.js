  ...
  return (
    <div className="h-full">
      ...
      <div className="flex flex-col p-12 space-y-4">
        <button
          className="w-full h-20 flex items-center justify-center px-8 py-4 border shadow-lg border-[#2DEEAA] text-[black] hover:bg-[#d3f8eb] rounded-xl bg-white   text-lg font-bold cursor-pointer"
