        ...
        mediaRecorderRef.current.onstop = async () => {
          try {
            ...
            if (expressionResponse) {
              ...
              setExpressionArray(prevArray => [...prevArray, expressionResponse])
          ...
          <div className="space-y-4 flex text-center justify-center">
            {recordingStatus === 'idle' && isVideoEnd && (
              <motion.button
                ...
                variant="contained"
                color="primary"
                className=" gap-3 flex items-center justify-center bg-black text-white rounded-full py-4 px-6 font-semibold transition-colors mb-6"
                >
                Record    <i className="fas fa-record-vinyl text-xl mr-2"></i>
              </motion.button>
            )}
